...
for i = 1:2:rad
    ...
    % 
    % Jag kollar i loopen om jag är på sista raden eller kolumnen i matrisen och då tar
    % jag endast de värdena jag kommer åt därifrån och samplar dem. På
    % detta vis kastar jag också bort så lite data som möjligt.